  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <DialogFooter className="p-6 grid grid-cols-2 gap-6 bg-gray-50/50 dark:bg-white/2 border-t dark:border-white/5">
          <Button
            variant="outline"
            onClick={() => onOpenChange(false)}
            className="rounded-xl hover:bg-black/5 bg-black/5 dark:bg-white/5 border-gray-100 dark:border-white/10 text-zinc-600 dark:text-zinc-400 transition-colors h-11 px-6"
          >
            Cancel
          </Button>
          <Button

...
import { TransactionFormData, transactionSchema } from "../types/transaction.types";
...
export const TransactionFormDialog = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      <DialogContent className=" sm:max-w-[425px] rounded-2xl p-0 bg-white dark:bg-[#1a1b21] border-gray-100 dark:border-white/5 shadow-xl overflow-hidden">
        <DialogHeader className="px-10 py-6">
        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="pb-2 grid gap-6">
          ...
          <DialogFooter className=" px-10 py-8 grid grid-cols-2 gap-6 bg-gray-50/50 dark:bg-white/2 border-t dark:border-white/5">
            <Button
              type="button"
              variant="outline"

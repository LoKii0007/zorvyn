...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:sticky top-0 left-0 z-[101] h-full w-64 shrink-0 bg-white dark:bg-[#1a1b21] flex flex-col py-8 px-5 border-r border-black/5 dark:border-white/3 gap-6 transition-all duration-300 ease-in-out lg:translate-x-0 ${
          isOpen
        ...
        <div className="pt-4 border-t border-black/5 dark:border-white/3 flex flex-col gap-1">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="w-full flex items-center justify-between gap-2 text-left px-3 py-2.5 rounded-xl text-sm hover:bg-black/5 dark:hover:bg-white/3 transition-colors outline-none">
            ...
            <DropdownMenuContent
              className="w-56 bg-white dark:bg-[#1f2027] rounded-xl shadow-lg border border-black/5 dark:border-white/5 p-2"
              align="start"
            >
          ...
          <button className="w-full flex items-center justify-between px-3 py-2.5 text-sm text-zinc-500 dark:text-zinc-500 hover:text-black dark:hover:text-zinc-200 hover:bg-black/5 dark:hover:bg-white/2 rounded-xl transition-colors">
